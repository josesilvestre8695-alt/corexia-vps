...
IA_MODULOS = [
    {"key": "corexia", "nome": "IA Corexia", "valor": 27.0, "pacote": True,
     "analiticos": [["arma_fogo", "Arma de fogo"], ["arma_branca", "Arma branca / faca"],
                    ...
                    ["pessoa", "Pessoa"], ["queda", "Pessoa caida / queda"], ["capacete", "Capacete / moto (rosto coberto)"], ["aglomeracao", "Aglomeracao de pessoas"], ["briga", "Briga / agressao (assistivo)"]]},
